...
func Build() {
	banner := figure.NewFigure("PubSubHub", "", true)
	banner.Print()
...
func (Bin) PubSubHub() error {
	return goBuild("go.zenithar.org/pubsubhub/cli/pubsubhub", "pubsubhub")
}
...
func goBuild(packageName, out string) error {
	...
	varsSetByLinker := map[string]string{
		"go.zenithar.org/pubsubhub/internal/version.Version":   tag(),
		"go.zenithar.org/pubsubhub/internal/version.Revision":  hash(),
		"go.zenithar.org/pubsubhub/internal/version.Branch":    branch(),
		"go.zenithar.org/pubsubhub/internal/version.BuildUser": os.Getenv("USER"),
		"go.zenithar.org/pubsubhub/internal/version.BuildDate": time.Now().Format(time.RFC3339),
		"go.zenithar.org/pubsubhub/internal/version.GoVersion": runtime.Version(),
	}
