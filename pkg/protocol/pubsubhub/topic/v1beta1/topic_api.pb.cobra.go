...
var TopicAPIClientCommand = &cobra.Command{
	Use: "topicAPI",
}

var topicAPI_CreateClientCommand = &cobra.Command{
	Use:  "create",
...
Authenticate using the Authorization header (requires transport security):
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		grpcClient := NewTopicAPIClient(conn)
...
func init() {
	TopicAPIClientCommand.AddCommand(topicAPI_CreateClientCommand)
	DefaultClientCommandConfig.AddFlags(topicAPI_CreateClientCommand.Flags())
}
