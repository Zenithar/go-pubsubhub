...
// source: pkg/protocol/pubsubhub/topic/v1beta1/topic.proto
...
func (*Message) Descriptor() ([]byte, []int) {
	return fileDescriptor_571ae07ad941a7b0, []int{0}
}
...
func (*Topic) Descriptor() ([]byte, []int) {
	return fileDescriptor_571ae07ad941a7b0, []int{1}
}
...
func init() {
	proto.RegisterFile("pkg/protocol/pubsubhub/topic/v1beta1/topic.proto", fileDescriptor_571ae07ad941a7b0)
}

var fileDescriptor_571ae07ad941a7b0 = []byte{
	...
	,
}
...
func NewPopulatedMessage(r randyTopic, easy bool) *Message {
	this := &Message{}
	if !easy && r.Intn(10) != 0 {
		this.XXX_unrecognized = randUnrecognizedTopic(r, 1)
	}
	return this
}
...
func randFieldTopic(dAtA []byte, r randyTopic, fieldNumber int, wire int) []byte {
	...
	case 0:
		...
		dAtA = encodeVarintPopulateTopic(dAtA, uint64(v2))
	case 1:
		dAtA = encodeVarintPopulateTopic(dAtA, uint64(key))
